...
+ ### Américo Bastos
|<img src="https://unsplash.com/pt-br/fotografias/VgVcraXFKFs" width="160" height="160">   |_22 anos, solteiro, é filho único e mora com os pais em uma casa no subúrbio de uma grande cidade._   |
|:---------------------------------------:|:-------------------------------:|
